            ...
            <div className="bg-gradient-to-br from-primary to-primary-dark rounded-lg p-8 shadow-lg">
              <div className="flex flex-col items-center lg:items-start space-y-6">
                ...
                <div className="flex space-x-4">
                  <button type="button" className="w-10 h-10 bg-white bg-opacity-20 rounded-full flex items-center justify-center hover:bg-opacity-30 transition duration-300">
